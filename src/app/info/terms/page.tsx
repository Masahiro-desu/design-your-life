...
export const metadata: Metadata = {
  title: "利用規約 | CMA",
  description: "CMAのサービス利用規約について説明します。",
};
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
          <section className="mb-8">
            <p className="text-gray-700 mb-6">
              この利用規約（以下「本規約」といいます）は、CMA株式会社（以下「当社」といいます）が提供するAIエージェントサービス「CMA」（以下「本サービス」といいます）の利用条件を定めるものです。
              ユーザーの皆様（以下「ユーザー」といいます）には、本規約に同意いただいた上で、本サービスをご利用いただくものとします。
            </p>
          </section>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">第4条（利用料金および支払方法）</h2>
            <ol className="list-decimal pl-5 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">第7条（利用制限および登録抹消）</h2>
            <ol className="list-decimal pl-5 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">第8条（退会）</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">第9条（保証の否認および免責事項）</h2>
            <ol className="list-decimal pl-5 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4">第10条（サービス内容の変更等）</h2>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4">第11条（利用規約の変更）</h2>
            <ol className="list-decimal pl-5 text-gray-700 space-y-2">
